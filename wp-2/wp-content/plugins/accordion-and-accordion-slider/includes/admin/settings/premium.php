...
<div class="wrap">
	...
	<h2><?php _e( 'Accordion and Accordion Slider - Features', 'accordion-and-accordion-slider' ); ?></h2><br />	
	...
	<table class="wpos-plugin-pricing-table">
	    ...
	    <thead>
	    	<tr>
	    		...
	    		<th>
	    			<h2>Premium</h2>
	    			<p>Gain access to <strong>Accordion and Accordion Slider</strong> and <strong>all other products</strong> with a single purchase.</p>
	    ...
	    <tfoot>
	    	<tr>
	    		<th></th>
	    		<td></td>
	    		<td><p>Gain access to <strong>Accordion and Accordion Slider</strong> and <strong>all other products</strong> with a single purchase.</p>
