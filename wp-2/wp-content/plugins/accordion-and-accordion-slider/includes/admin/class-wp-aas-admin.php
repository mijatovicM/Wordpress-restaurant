...
class Wp_Aas_Admin {
	...
	function wp_aas_register_menu() {
		...
		add_submenu_page( 'edit.php?post_type='.WP_AAS_POST_TYPE, __('Upgrade to PRO - Accordion and Accordion Slider', 'accordion-and-accordion-slider'), '<span style="color:#2ECC71">'.__('Upgrade to PRO', 'accordion-and-accordion-slider').'</span>', 'manage_options', 'wp-aas-premium', array($this, 'wp_aas_premium_page') );

		// Register plugin hire us page
		add_submenu_page( 'edit.php?post_type='.WP_AAS_POST_TYPE, __('Hire Us', 'accordion-and-accordion-slider'), '<span style="color:#2ECC71">'.__('Hire Us', 'accordion-and-accordion-slider').'</span>', 'manage_options', 'wp-aas-hireus', array($this, 'wp_aas_hireus_page') );
	}
	 ...
	 * @since 1.0.0
	 */
	function wp_aas_hireus_page() {		
		include_once( WP_AAS_DIR . '/includes/admin/settings/hire-us.php' );
	}
